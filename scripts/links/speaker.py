...
class NaiveSpeaker(chainer.Chain):
    ...
    def think(self, hidden_image, hidden_canvas, train=True):
        ...
        thought = F.tanh(self.l3(h2))
        return thought

    def __call__(self, hidden_image, hidden_canvas, train=True):
        return self.think(hidden_image, hidden_canvas, train=true)
